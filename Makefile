...
IMG ?= quay.io/fpaoline/frrk8s:0.1.0
...
test: manifests generate fmt vet envtest ## Run tests.
	KUBEBUILDER_ASSETS="$(shell $(ENVTEST) use $(ENVTEST_K8S_VERSION) --bin-dir $(LOCALBIN) -p path)" go test ./... -coverprofile cover.out -short
...
.PHONY: load-on-kind
load-on-kind: docker-build ## Load the docker image into the kind cluster.
