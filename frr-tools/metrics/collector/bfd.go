...
var (
	bfdSessionUpDesc = prometheus.NewDesc(
		prometheus.BuildFQName(metrics.Namespace, subsystem, metrics.SessionUp.Name),
	...
	controlPacketInputDesc = prometheus.NewDesc(
		prometheus.BuildFQName(metrics.Namespace, subsystem, "control_packet_input"),
	...
	controlPacketOutputDesc = prometheus.NewDesc(
		prometheus.BuildFQName(metrics.Namespace, subsystem, "control_packet_output"),
	...
	echoPacketInputDesc = prometheus.NewDesc(
		prometheus.BuildFQName(metrics.Namespace, subsystem, "echo_packet_input"),
	...
	echoPacketOutputDesc = prometheus.NewDesc(
		prometheus.BuildFQName(metrics.Namespace, subsystem, "echo_packet_output"),
	...
	sessionUpEventsDesc = prometheus.NewDesc(
		prometheus.BuildFQName(metrics.Namespace, subsystem, "session_up_events"),
	...
	sessionDownEventsDesc = prometheus.NewDesc(
		prometheus.BuildFQName(metrics.Namespace, subsystem, "session_down_events"),
	...
	zebraNotificationsDesc = prometheus.NewDesc(
		prometheus.BuildFQName(metrics.Namespace, subsystem, "zebra_notifications"),
