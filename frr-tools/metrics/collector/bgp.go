...
import (
	...
	"github.com/metallb/frrk8s/internal/metrics"
...
var (
	sessionUpDesc = prometheus.NewDesc(
		prometheus.BuildFQName(metrics.Namespace, metrics.Subsystem, metrics.SessionUp.Name),
		metrics.SessionUp.Help,
		labels,
		nil,
	)

	prefixesDesc = prometheus.NewDesc(
		prometheus.BuildFQName(metrics.Namespace, metrics.Subsystem, metrics.Prefixes.Name),
		metrics.Prefixes.Help,
		labels,
		nil,
	)

	opensSentDesc = prometheus.NewDesc(
		prometheus.BuildFQName(metrics.Namespace, metrics.Subsystem, "opens_sent"),
	...
	opensReceivedDesc = prometheus.NewDesc(
		prometheus.BuildFQName(metrics.Namespace, metrics.Subsystem, "opens_received"),
	...
	notificationsSentDesc = prometheus.NewDesc(
		prometheus.BuildFQName(metrics.Namespace, metrics.Subsystem, "notifications_sent"),
	...
	updatesSentDesc = prometheus.NewDesc(
		prometheus.BuildFQName(metrics.Namespace, metrics.Subsystem, metrics.UpdatesSent.Name),
		metrics.UpdatesSent.Help,
		labels,
		nil,
	)

	updatesReceivedDesc = prometheus.NewDesc(
		prometheus.BuildFQName(metrics.Namespace, metrics.Subsystem, "updates_total_received"),
	...
	keepalivesSentDesc = prometheus.NewDesc(
		prometheus.BuildFQName(metrics.Namespace, metrics.Subsystem, "keepalives_sent"),
	...
	keepalivesReceivedDesc = prometheus.NewDesc(
		prometheus.BuildFQName(metrics.Namespace, metrics.Subsystem, "keepalives_received"),
	...
	routeRefreshSentedDesc = prometheus.NewDesc(
		prometheus.BuildFQName(metrics.Namespace, metrics.Subsystem, "route_refresh_sent"),
	...
	totalSentDesc = prometheus.NewDesc(
		prometheus.BuildFQName(metrics.Namespace, metrics.Subsystem, "total_sent"),
	...
	totalReceivedDesc = prometheus.NewDesc(
		prometheus.BuildFQName(metrics.Namespace, metrics.Subsystem, "total_received"),
...
func NewBGP(l log.Logger) prometheus.Collector {
	log := log.With(l, "collector", metrics.Subsystem)
