...
func NewUpdater(r *rest.Config) (*Updater, error) {
	...
	if err := frrk8sv1alpha1.AddToScheme(myScheme); err != nil {
		return nil, err
	}
...
func (u *Updater) Update(configs ...frrk8sv1alpha1.FRRConfiguration) error {
...
func (u *Updater) Clean() error {
	err := u.client.DeleteAllOf(context.Background(), &frrk8sv1alpha1.FRRConfiguration{})
